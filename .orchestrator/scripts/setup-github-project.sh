...
# read/write the fields this script creates (see .orchestrator/scripts/update-ticket-stage.sh
...
#
# Usage:
#   ./.orchestrator/scripts/setup-github-project.sh <owner> <repo> ["<project title>"]
#
# Example:
#   ./.orchestrator/scripts/setup-github-project.sh my-org my-web-app "Feature Chain"
