...
- Every collection has exactly one Mongoose model file under `server/models/`.
...
- **Requires a migration script under `migrations/`**: renaming a field, narrowing/adding a
...
- One migration script per schema-changing feature, under `migrations/<feature-slug>-<short-desc>.js`,
